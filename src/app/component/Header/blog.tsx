...
const Blog = () => {
  return (
    <div className="flex flex-col items-center justify-center px-6 py-20 bg-white">
      {/* Heading Section */}
      <h1 className="text-[24px] md:text-[36px] font-bold text-center text-black">Our Blogs</h1>
      <p className="text-[15px] font-medium text-[gray] text-center max-w-2xl pt-4 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20 ">
        ...
        <div className="hover:shadow-lg md:w-[287px] md:h-[397px]  flex flex-col  items-center rounded-[4px] p-5 md:p-4">
          ...
          <div className="flex justify-center items-center h-[200px] w-full mb-4">
            <Image
              src="/images/06433f2420891f403a591b053ab0ddfd.jpg"
              alt=""
              width={250}
              height={250}
          ...
          <div className="w-full flex flex-col items-center mt-[35px]">
            <p className="text-[12px] md:text-[15px] font-medium text-center text-black">
            ...
            <div className="flex items-center justify-center text-[12px] md:text-[14px] mt-6 gap-2 text-black">
              <Image
        ...
        <div className="hover:shadow-lg md:w-[287px] md:h-[397px]  flex flex-col  items-center rounded-[4px] p-5 md:p-4">
          <div className="flex justify-center items-center h-[200px] w-full mb-4">
            <Image
              src="/images/2730568e294fb8ff45f6b0b0ce5dfec1.jpg"
              alt=""
              width={250}
              height={250}
              className="object-contain"
          ...
          <div className="w-full flex flex-col items-center mt-[35px]">
            ...
            <div className="flex items-center justify-center text-[14px] mt-6 gap-2 text-black" >
               <Image
              src={'/images/Group.webp'}
                              alt=''
                              width={18}
        ...
        <div className="hover:shadow-lg md:w-[287px] md:h-[397px]  flex flex-col  items-center rounded-[4px] p-5 md:p-4">
          <div className="flex justify-center items-center h-[200px] w-full mb-4">
            <Image
              src="/images/74d9976eaa2789b598b2896a0149302a.jpg"
              alt=""
              width={250}
              height={250}
              className="object-contain"
