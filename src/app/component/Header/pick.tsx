...
function Picks() {
  ...
  const data: IData[] = [
    {
      ...
      price: '25,000.00',
      image: '/images/58e39805d460c4c63cccc8a518ca116f.png',
    },
    {
      id: 2,
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-20 bg-white">
      {/* Heading Section */}
      <h1 className=" text-[24px] md:text-[36px] font-bold text-center text-black ">Top Picks For You</h1>
        ...
        {data.map((product) => (
          ...
          >
            ...
            <div className="w-full mt-[35px]">
              <p className=" text-[12px] md:text-[15px] md:font-medium text-left text-gray-400">{product.title}</p>
